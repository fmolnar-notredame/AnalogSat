...
#ifndef ANALOGSAT_FASTSATMAKER_H
#define ANALOGSAT_FASTSATMAKER_H
...
namespace analogsat
{
	...
	//clauses are not checked for repetition, but they do not have the same variable twice
	class FastSatMaker : public ISatMaker
	{
	public:
		FastSatMaker();
		FastSatMaker(unsigned long seed);

		virtual ~FastSatMaker() override;
