...
#ifndef ANALOGSAT_CPUSAT_TANH_H
#define ANALOGSAT_CPUSAT_TANH_H
...
namespace analogsat
{
	...
	// implements the RHS of the equation, with the Tanh formula
	// supports incomplete clauses
	template<typename TFloat>
	class CpuSatTanh : public ISat<TFloat, CpuODEState<TFloat>>
	{
	private:
		...
		TFloat knorm;
		std::vector<TFloat> kmi;
		std::vector<TFloat> si;
	...
	public:
		...
		//set the q parameter of the Tanh
